...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_NO,   KC_NO,   KC_NO,   MO1_ESC, SFT_SPC, CTL_ENT, MO2_BSP, KC_NO,   KC_NO,   KC_NO
  ),
  [1] = LAYOUT(
    ...
    KC_NO,   KC_NO,   KC_NO,   KC_TRNS, KC_TRNS, KC_MINS, KC_0,    KC_NO,   KC_NO,   KC_NO
  ),
  [2] = LAYOUT(
    ...
    KC_NO,   KC_NO,   KC_NO,   KC_GRV,  KC_UNDS, TO(3),   KC_TRNS, KC_NO,   KC_NO,   KC_NO
  ),
  [3] = LAYOUT(
    ...
    KC_NO,   KC_NO,   KC_NO,   KC_LCTL, KC_SPC,  KC_LALT, TO(0),   KC_NO,   KC_NO,   KC_NO
  )
};
